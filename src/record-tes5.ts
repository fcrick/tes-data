...
var subRecordFields: FieldArray = [
  ...
  ['recordType', {
    ...
    ['type', {
      ...
      _MODT: types.modt, _DMDT: types.modt, _MO2T: types.modt, _MO3T: types.modt, _MO4T: types.modt, _MO5T: types.modt,
      _MODS: types.mods, _DMDS: types.mods, _MO2S: types.mods, _MO3S: types.mods, _MO4S: types.mods, _MO5S: types.mods,
      _NVMI: [
        ['navmesh', 'uint32le'],
        ['unknown1', 'uint32le'],
        ['x', 'float'],
      ...
      _DATA: [
        ['recordType', {
          ...
          _APPA: types.goldAndWeight,
          _ARMO: types.goldAndWeight,
          _BOOK: [
            ['flags', 'uint8'],
            ['bookType', 'uint8'],
            ['unknown', 'uint16le'],
